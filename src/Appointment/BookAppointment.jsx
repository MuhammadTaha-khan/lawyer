          ...
          <div className="d-flex justify-content-center">
            <div className="app-button col-md-8 d-flex justify-content-between mt-3">
              ...
              {currentStep === steps.length - 1 ? (
                <Button onClick={onSubmit}>Submit</Button> // Bind onSubmit here
              ) : (
...
// const BookAppointment = () => {
//   const [currentStep, setCurrentStep] = useState(0);
//   const appointment = useSelector((state) => state.appointment); // Assuming you're using Redux
...
//       Phone: ${appointment.basicDetails.phoneNumber}
...
//     try {
//       await axios.post('http://localhost:3001/send-whatsapp', { message });
